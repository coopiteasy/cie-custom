...
[lpcr_custom_restricted_product_access](lpcr_custom_restricted_product_access/) | 16.0.1.1.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Restrict write, create and delete access for products to a single group
