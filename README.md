...
[lpcr_pos_product_fixed_price](lpcr_pos_product_fixed_price/) | 16.0.1.1.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Add the possibility to set a product as having a fixed price in the PoS that can only be changed by a manager.
