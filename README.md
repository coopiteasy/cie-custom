...
[foodhub_custom_purchase_report_uom](foodhub_custom_purchase_report_uom/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | replace the purchase UoM Qty in the purchase report by the product UoM Qty
[foodhub_custom_unit_price_report](foodhub_custom_unit_price_report/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | add custom unit price and rename Unit Price to Box Price
...
[lpcr_custom_membership_expiry_mail](lpcr_custom_membership_expiry_mail/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Send a mail to members whose membership will expire in a month.
[lpcr_custom_pos_buttons](lpcr_custom_pos_buttons/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Add a button redirecting to the lpcr contact form and another to the members national view in the PoS
[lpcr_custom_restricted_product_access](lpcr_custom_restricted_product_access/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Restrict write, create and delete access for products to a single group
...
[lpcr_pos_product_fixed_price](lpcr_pos_product_fixed_price/) | 16.0.1.0.0 | <a href='https://github.com/mihien'><img src='https://github.com/mihien.png' width='32' height='32' style='border-radius:50%;' alt='mihien'/></a> | Add the possibility to set a product as having a fixed price in the PoS that can only be changed by a manager.
